...
<template>
  <div class="text-center mt-2">
    <button
      ...
      class="rounded-xl bg-gray-700 px-2 text-white dark:bg-gray-200 dark:text-gray-700 dark:hover:text-purple-700"
    >
  ...
  <Vue3TailwindModal
    ...
    colors="bg-gray-400 dark:bg-gray-700 dark:text-gray-200"
  >
    ...
    dark mode and see the modal change!
  </Vue3TailwindModal>
</template>
